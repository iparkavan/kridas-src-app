...
const columns = [
	...
	{ id: "totalAppointments", label: "Total Appointments", minWidth: 200, align: "left" },
];
...
export default function MonthlyAppointmentsDetail(props) {
	...
	useEffect(() => {
		...
		setTotalAppointments(props.reportdata.reduce((prev, cur) => prev + cur.totalAppointments, 0));
	}, []);
				...
				<Table stickyHeader aria-label='sticky table' size='small'>
					...
					<TableBody>
						<TableRow>
							...
							<TableCell style={txtBoldStyle}>{totalAppointments}</TableCell>
						</TableRow>
					</TableBody>
