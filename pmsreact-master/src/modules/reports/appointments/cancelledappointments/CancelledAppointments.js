...
import CancelledAppointmentsDetail from "./CancelledAppointmentsDetail";
import CancelledAppointmentsPrint from "./CancelledAppointmentsPrint";

import Tooltip from "@material-ui/core/Tooltip";
import { withStyles } from "@material-ui/core/styles";
import Typography from "@material-ui/core/Typography";

const CancelledAppointmentsReports = (props) => {
	...
	return (
		<>
			...
			{loading ? <CancelledAppointmentsDetail reportdata={appointmentsReports} /> : ""}{" "}
		</>
	);
};

export default CancelledAppointmentsReports;
