...
import AllAppointmentsDetail from "./AllAppointmentsDetail";
import AllAppointmentsPrint from "./AllAppointmentsPrint";

import Tooltip from "@material-ui/core/Tooltip";
import { withStyles } from "@material-ui/core/styles";
import Typography from "@material-ui/core/Typography";

const AllAppointmentsReports = (props) => {
	...
	return (
		<>
			...
			<div>
				{" "}
				{loading ? <AllAppointmentsSummary reportdata={appointmentsReports?.appointmentSummaryReport} /> : ""} <br />
				<br />
			</div>{" "}
			{loading ? <AllAppointmentsDetail reportdata={appointmentsReports} /> : ""}{" "}
		</>
	);
};

export default AllAppointmentsReports;
