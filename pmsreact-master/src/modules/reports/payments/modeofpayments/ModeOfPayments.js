...
import ModeOfPaymentsDetail from "./ModeOfPaymentsDetail";
import ModeOfPaymentsPrint from "./ModeOfPaymentsPrint";

import Tooltip from "@material-ui/core/Tooltip";
import { withStyles } from "@material-ui/core/styles";
import Typography from "@material-ui/core/Typography";

const ModeOfPaymentsReports = (props) => {
	const [moPaymentsReports, setMoPaymentsReports] = useState([]);
	const [loading, setLoading] = useState(false);

	const componentRef = useRef();

	useEffect(() => {
		setMoPaymentsReports(props.reportdata);
		setLoading(true);
	}, []);
	...
	return (
		<>
			...
			{loading ? <ModeOfPaymentsDetail reportdata={moPaymentsReports} reportlocale={props.reportlocale} reportcurrency={props.reportcurrency} /> : ""}{" "}
		</>
	);
};

export default ModeOfPaymentsReports;
