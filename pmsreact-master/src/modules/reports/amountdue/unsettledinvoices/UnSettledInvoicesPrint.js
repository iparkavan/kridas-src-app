...
class UnSettledInvoicesPrint extends Component {
	constructor(props) {
		super(props);
		this.state = {};
	}
	...
	render() {
		return (
			<div>
				...
				<UnsettledInvoiceSummary reportcurrency={this.props.reportcurrency} reportdata={this.props.reportdata} />
...
export default UnSettledInvoicesPrint;
