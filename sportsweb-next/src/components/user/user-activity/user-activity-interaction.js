                      ...
                      <Fragment key={index}>
                        {activity?.activityType === "CMT" && (
                          ...
                          >
                            <HStack>
                              <TextSmall>
                                {userData.full_name} commented on
                              </TextSmall>
                              <TextSmall>
                                {activity?.eventTypeRefName}&apos;s post
                              </TextSmall>
                              <Spacer />
                              <TextSmall>
                        ...
                        {activity?.activityType === "LIK" && (
                          ...
                          >
                            <HStack>
                              <TextSmall>{userData.full_name} likes</TextSmall>
                              <TextSmall cursor="pointer">
                                {activity?.eventTypeRefName}
                                &apos;s post
                              </TextSmall>
                              <Spacer />
