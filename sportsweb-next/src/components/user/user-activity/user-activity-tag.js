                          ...
                          >
                            <HStack>
                              <TextSmall>
                                ...
                                {/* {activity?.action_details?.details?.name} */}
                                {userData.full_name} tagged{" "}
                                {activity?.eventTypeRefName} in a post.
                              </TextSmall>
                              <Spacer />
                              <TextSmall>
                          ...
                          >
                            <HStack>
                              <TextSmall>
                                ...
                                {/* {activity?.action_details?.details?.name}  */}
                                {userData.full_name} tagged{" "}
                                {activity?.eventTypeRefName} in a comment.
                              </TextSmall>
                              <Spacer />
                              <TextSmall>
                                {formatTime(activity?.createdDate)}
