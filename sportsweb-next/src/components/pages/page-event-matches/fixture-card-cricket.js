...
function FixturesCardCricket({
  ...
  let sports_code_cricket = "SPOR05";
              ...
              <GridItem colSpan={4} w="full">
                <SimpleGrid columns={3}>
                  ...
                  <Box
                    ...
                    ml={3}
                  >
                    <TextMedium>Overs</TextMedium>
                  </Box>
                </SimpleGrid>
                <SimpleGrid mt={2} columns={3} w="full">
...
export default FixturesCardCricket;
