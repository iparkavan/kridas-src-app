...
Repository for SportzPlatform admin modules.
...
```
cd existing_repo
git remote add origin https://gitlab.com/sportsplatform1/sportsadmin.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/-/experiment/new_project_readme_content:56d6c5db42e710eebdf4410fb5332f7f?https://docs.gitlab.com/ee/user/project/integrations/)
