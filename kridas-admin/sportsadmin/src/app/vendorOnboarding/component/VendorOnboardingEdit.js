...
import CompanyInfomation from "../../company/components/CompanyInformation";
...
const VendorOnboardingEdit = (props) => {
    ...
    <>
      <PageContainer heading="Edit Company">
        <AppBar className={classes.userTab} position="static">
          ...
          >
            <Tab label="Page Verification" {...a11yProps(0)} />
            <Tab label="Terms & Conditions" {...a11yProps(1)} key={1} />
        ...
        <TabPanel value={value} index={2} className={classes.imgbtn}>
          <BankDetails
            setUserDetails={setCompanyDetails}
            userDetails={companyDetails}
            component="Company"
...
export default VendorOnboardingEdit;
