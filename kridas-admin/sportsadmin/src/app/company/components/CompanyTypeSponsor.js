...
const CompanyTypeSponsor = (props) => {
  ...
  useEffect(() => {
    const config =
      ServiceProviderConfig.getSponsorProviderByCompanyId(companyId);
  ...
  if (!isLoading && sponsorProviderDetails === null) {
    return <BodyText>Company not registered for Sponsor Provider</BodyText>;
  }
  ...
  return isLoading ? (
    ...
    <div>
      ...
      {sponsorProviderDetails.company !== null ? (
        <>
          ...
          <div className={classes.sectionSpace}>
            ...
            <div className={classes.contentSpace}>
              <CompanyUsersList
                userList={sponsorProviderDetails.company.companyUsers}
              ></CompanyUsersList>
            </div>
          </div>
          <div className={classes.sectionSpace}>
...
export default CompanyTypeSponsor;
